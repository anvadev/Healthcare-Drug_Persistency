...
df.to_csv('C:/Users/msavg/Documents/Healthcare-Drug_Persistency/Week 12 - Model Selection and Model Building+Dashboard/healthcare_data_cleaned.csv', index=False)
df = None
###########################################
